...
```
compile 'me.xia:fragmentation-core-androidx:1.0.4'
```
...
```
compile 'me.xia:fragmentation-with-androidx:1.0.4'
```
...
```
compile 'me.xia:fragmentation-swipeback-androidx:1.0.4'
```
...
```
compile 'me.xia:eventbus-activity-scope-androidx:1.0.4'
```
