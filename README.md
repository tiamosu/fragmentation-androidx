...
```groovy
implementation 'me.xia:fragmentation-core-androidx:1.1.1'
```
...
```groovy
implementation 'me.xia:fragmentation-with-androidx:1.1.1'
```
...
```groovy
implementation 'me.xia:fragmentation-swipeback-androidx:1.1.1'
```
...
```groovy
implementation 'me.xia:eventbus-activity-scope-androidx:1.1.1'
```
