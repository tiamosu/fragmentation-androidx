...
```groovy
compile 'me.xia:fragmentation-core-androidx:1.0.8'
```
...
```groovy
compile 'me.xia:fragmentation-with-androidx:1.0.8'
```
...
```groovy
compile 'me.xia:fragmentation-swipeback-androidx:1.0.8'
```
...
```groovy
compile 'me.xia:eventbus-activity-scope-androidx:1.0.8'
```
